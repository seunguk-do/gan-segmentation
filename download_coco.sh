...
wget https://github.com/nightrome/cocostuff/blob/master/labels.txt -O $COCO_DIR/labels.txt
wget https://github.com/nightrome/cocostuff/blob/master/labels.md -O $COCO_DIR/labels.md
